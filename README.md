...
> Status: **v0.3.0 release gate passed; ready for the `v0.3.0` tag and Release workflow**. The repository is structured for repeatable Windows CI, installer validation, and tagged prereleases.
