...
public sealed class Localizer
{
    ...
    {
        ["File"] = "_File", ["Open"] = "_Open...", ["OpenFolder"] = "Open _Folder...", ["Exit"] = "E_xit",
        ...
        ["Fullscreen"] = "Fullscreen", ["Bookmarks"] = "_Bookmarks", ["AddBookmark"] = "Add Bookmark", ["EditBookmarks"] = "Edit Bookmarks...",
    ...
    {
        ["File"] = "ファイル(_F)", ["Open"] = "開く(_O)...", ["OpenFolder"] = "フォルダーを開く...", ["Exit"] = "終了(_X)",
        ...
        ["Fullscreen"] = "全画面", ["Bookmarks"] = "ブックマーク(_B)", ["AddBookmark"] = "ブックマーク追加", ["EditBookmarks"] = "ブックマーク一覧...",
