...
public sealed class Localizer
{
    ...
    private static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>
    {
        ...
        ["OpenComic"] = "Open comic archive", ["OpenSelected"] = "Open", ["OpenFailed"] = "Could not open this item.", ["ComicFiles"] = "Comic archives and images", ["AllFiles"] = "All files", ["Error"] = "Error", ["PageLoadFailed"] = "This page could not be loaded.", ["PageLoadFailedHint"] = "You can continue with the previous or next page.", ["BookmarksTitle"] = "Bookmarks", ["NoBookmarks"] = "No bookmarks yet.",
    ...
    private static readonly IReadOnlyDictionary<string, string> Ja = new Dictionary<string, string>
    {
        ...
        ["OpenComic"] = "漫画書庫を開く", ["OpenSelected"] = "開く", ["OpenFailed"] = "この項目を開けませんでした。", ["ComicFiles"] = "漫画書庫と画像", ["AllFiles"] = "すべてのファイル", ["Error"] = "エラー", ["PageLoadFailed"] = "このページを読み込めませんでした。", ["PageLoadFailedHint"] = "前後のページへそのまま移動できます。", ["BookmarksTitle"] = "ブックマーク", ["NoBookmarks"] = "ブックマークはありません。",
